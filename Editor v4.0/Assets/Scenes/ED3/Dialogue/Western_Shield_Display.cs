...
public class Western_Shield_Display : EventController {
	void Start() { Load(); }
	public void Load() {
		...
		"{" +
			...
			"    {" +
			"      \"command\": {" +
			"        \"_name\": \"Western Shield\"," +
			"        \"_portrait\": null," +
			"        \"_positionLeft\": true," +
			"        \"_text\": \"A shield used by roman legions. Can be used to make the famous turtle formations.\"," +
			"        \"next\": {" +
			"          \"$ref\": \"7\"" +
			"        }," +
			"        \"controller\": null," +
