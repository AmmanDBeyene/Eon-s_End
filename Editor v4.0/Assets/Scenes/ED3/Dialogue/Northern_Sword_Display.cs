...
public class Northern_Sword_Display : EventController {
	void Start() { Load(); }
	public void Load() {
		...
		"{" +
			...
			"    {" +
			"      \"command\": {" +
			"        \"_name\": \"Northern Sword\"," +
			"        \"_portrait\": null," +
			"        \"_positionLeft\": true," +
			"        \"_text\": \"Sharp steel swords like these are a prevalent weapon throughout the North.\"," +
			"        \"next\": {" +
			"          \"$ref\": \"7\"" +
			"        }," +
			"        \"controller\": null," +
