...
public class Slavic_Ship_Display : EventController {
	void Start() { Load(); }
	public void Load() {
		...
		"{" +
			...
			"        \"_portrait\": null," +
			"        \"_positionLeft\": true," +
			"        \"_text\": \"A standard Northern ship consisted of a single set of oars, a square sail, and a set of shields for protection.\"," +
			"        \"next\": {" +
			"          \"$ref\": \"7\"" +
			"        }," +
			"        \"controller\": null," +
