...
public class artifact_2_collect : EventController {
	void Start() { Load(); }
	public void Load() {
		...
		"{" +
			...
			"        \"_portrait\": null," +
			"        \"_positionLeft\": true," +
			"        \"_text\": \"You dust off the artifact and put it in your pouch.\"," +
			"        \"next\": {" +
			"          \"$ref\": \"8\"" +
			"        }," +
			"        \"controller\": null," +
			...
			"        \"_portrait\": null," +
			"        \"_positionLeft\": true," +
			"        \"_text\": \"An artifact sitting neatly in a dustry corner of the room.\"," +
			"        \"next\": {" +
			"          \"$ref\": \"13\"" +
			"        }," +
			"        \"controller\": null," +
