...
public class AssetBarController : MonoBehaviour
{
    ...
    void Load2D()
    {
        ...
        string[] assets = AssetDatabase.FindAssets("t:material", new[] { "Assets/Designer Assets/Materials" });
        foreach (string asset in assets)
        {
            string path = AssetDatabase.GUIDToAssetPath(asset);
    ...
    void Load3D()
    {
        var assets = AssetDatabase.FindAssets("t:prefab", new[] { "Assets/Designer Assets/3D Tiles" });
