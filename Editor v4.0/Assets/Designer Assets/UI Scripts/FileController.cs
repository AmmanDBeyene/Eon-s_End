...
public class FileController : MonoBehaviour
{
    ...
    void LoadClicked()
    {
        ...
        currentSavePath = EditorUtility.OpenFilePanel("Open Map Prefab", "Assets/Designer Assets/Output", "prefab");
    ...
    void SaveAsClicked()
    {
        ...
        "Save Map Prefab", "Assets/Designer Assets/Output", "map.prefab",
            "prefab");
